...
//		String p8_Url = "http://localhost:8080/shop/order_callBack.action"; // 商户接收支付成功数据的地址:127.0.0。1  localhost 
//		String p9_SAF = ""; // 送货地址:
//		String pa_MP = ""; // 商户扩展信息:
...
//		StringBuffer sb = new StringBuffer("https://www.yeepay.com/app-merchant-proxy/node?");
		StringBuffer sb = new StringBuffer("http://localhost:8080/shop/wechatpay.jsp");
